...
namespace kfutils {
    ...
    public class SpatialHash {
        ...
        protected readonly ulong seed1;
        ...
        protected ulong GenSecondSeed(ulong val) {
            val *= 5443;
         ...
         * @return
         */
        protected static ulong rotateLeft(ulong val, int dist) {
         ...
         * @return
         */
        protected static ulong rotateRight(ulong val, int dist) {
            return (val >> dist) | (val << (64 - dist));
        }
