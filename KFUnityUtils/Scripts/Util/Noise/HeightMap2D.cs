...
namespace kfutils.noise
{
    ...
    public class HeightMap2D
    {
        ...
        public float[,] Process(Xorshift rand)
            ...
            protected void ProcessOne(Xorshift rand)
            {
            ...
            protected float CalcLoc(Vector2 from, Vector2 at, float ci)
            {
                double dx = at.x / ci;
                double dy = at.y / ci;
            ...
            protected float Fade(float input)
            {
                return input * input * input * (input * (input * 6 - 15) + 10);
            }


            protected float FullFade(float input)
            {
