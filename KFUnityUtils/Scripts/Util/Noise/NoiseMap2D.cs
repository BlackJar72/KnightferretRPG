namespace kfutils.noise {
    ...
    public class NoiseMap2D {
         ...
         * @param startz
         */
        protected void ProcessOne(int startz) {
         ...
         */
        protected double CalcLoc(Vec2D from, Vec2D at, double ci) {
            double dx = at.x / ci;
            double dy = at.y / ci;
         ...
         * @return
         */
        protected double Fade(double val) {
         ...
         * @return
         */
        protected double FullFade(double val) {
