...
/*
     NOTE TO SELF: A SYSTEM BASED ON THIS MIGHT BE BETTER FOR FUTURE GAMES, AS ITS 
     FLEXIBLITY WOULD ALLOW THINGS LIKE SPELLS EQUIPT TO HANDS.

     HOWEVER, IT MAY BE MORE TROUBLE THAN ITS WORTH TO RETROFIT THIS ALL TO USE A 
     SYSTEM LIKE THAN.  FOR THE TIME BEING, IT MIGHT BE A BETTER IDEA TO JUST CHANGE 
     THE HOT BAR TO USE THIS KIND OF SYSTEM, ELIMINATING THE COMPLEXITIES OF TRAKING 
     ITEMS THROUGH INDIRECT REFERNCE OBJECTS, WHILE LEAVING THE NON-BROKEN PARTS ALONE. 

     I'LL HAVE TO THINKING ABOUT IT.
*/
